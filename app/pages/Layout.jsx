...
import {
  ...
  Handshake,
  HelpCircle,
  Calendar as CalendarIcon, // Import the new icon
  Heart // Added Heart icon for Donate
} from "lucide-react";
...
{
  title: "Timeline", // Changed from "Calendar" to "Timeline"
              ...
              <div className="h-full flex flex-col">
                ...
                <div className="flex-1 overflow-y-auto">
                  <nav className="px-4 py-6 pb-20 space-y-2">
                    {navigationItems.map((item, index) => {
                      if (item.desktopOnly) return null; // Filter out desktopOnly items for mobile
